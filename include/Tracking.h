...
public:
    ...
    cv::Mat GrabImageRGBD(const cv::Mat &imRGB,const cv::Mat &imD, const double &timestamp, string filename, const ORB_SLAM3::objectdetection& objects = ORB_SLAM3::objectdetection{});
