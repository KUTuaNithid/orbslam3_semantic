...
public:
    ...
    // Returns the camera pose (empty if tracking fails).
    cv::Mat TrackRGBD(const cv::Mat &im, const cv::Mat &depthmap, const double &timestamp, const ORB_SLAM3::objectdetection& objects = ORB_SLAM3::objectdetection{}, string filename="");
